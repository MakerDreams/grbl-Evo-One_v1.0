...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_MAKERDREAMS_EVO_ONE_V1_0
  // Grbl settings for MakerDreams Evo-One CNC Machine (V1.0 Kickstarter version)
  // https://makerdreams.com
  ...
  #define DEFAULT_Z_MAX_RATE 1700.0 // mm/min
  #define DEFAULT_X_ACCELERATION (110.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (110.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (110.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 389.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 222.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 120.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 22000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  ...
  #define DEFAULT_LASER_MODE 0 // false
  #define DEFAULT_HOMING_ENABLE 1  // false
  #define DEFAULT_HOMING_DIR_MASK ((1<<X_AXIS)|(0<<Y_AXIS)|(0<<Z_AXIS)) // move positive dir
...
#ifdef DEFAULTS_MAKERDREAMS_EVO_ONE_V2018
  // Grbl settings for MakerDreams Evo-One CNC Machine (V2018 updated version)
  // https://makerdreams.com
  #define DEFAULT_X_STEPS_PER_MM 80
  #define DEFAULT_Y_STEPS_PER_MM 80
  #define DEFAULT_Z_STEPS_PER_MM 160
  #define DEFAULT_X_MAX_RATE 8000.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 8000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 3500.0 // mm/min
  ...
  #define DEFAULT_X_MAX_TRAVEL 371.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 224.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 120.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 19500.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK ((1<<X_AXIS)|(1<<Y_AXIS)|(0<<Z_AXIS))
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 255 // msec (0-254, 255 keeps steppers enabled)
  #define DEFAULT_STATUS_REPORT_MASK 1 // MPos enabled
  #define DEFAULT_JUNCTION_DEVIATION 0.01 // mm
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
